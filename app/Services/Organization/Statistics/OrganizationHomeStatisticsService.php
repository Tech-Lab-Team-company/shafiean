...
namespace App\Services\Organization\Statistics;
...
class OrganizationHomeStatisticsService
{
    public function fetchCounts()
    {
        try {
            ...
            $parents = $this->parentCount();

            return new DataSuccess(
                data: new OrganizationHomeCountStatisticResource([
    ...
    private function parentCount()
    {
        return User::whereType(UserTypeEnum::PARENT->value)->count();
    }
}
